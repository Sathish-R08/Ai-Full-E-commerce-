        ...
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]  '>
                <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                    ...
                    <p className='text-[19px] md:text-[20px] text-[black] '>Mercenta</p>
            
                </div>
                <p className='text-[15px] text-[#1e2223] hidden md:block'>Mercenta is your ultimate online shopping destination, delivering top-quality products, unbeatable deals, and lightning-fast delivery — all backed by a service you can trust, designed to simplify your everyday life.</p>
                    <p className='text-[15px] text-[#1e2223] flex md:hidden'>Fast. Easy. Reliable. Mercenta Shopping</p>
            ...
            <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <div className='md:w-[25%] w-[40%]  h-[100%] flex items-center justify-center flex-col text-center '>
                     ...
                     <ul>
                         <li className='text-[15px] text-[#1e2223] '>+91-6369440965</li>
                        <li className='text-[15px] text-[#1e2223] '>contact@Mercenta.com</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>+1-123-456-7892</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>admin@Mercenta.com</li>
                    </ul>
                </div>

        </div>
        <div className='w-[100%] h-[1px] bg-slate-400'></div>
        <div className='w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright 2025@Mercenta.com-All Rights Reserved</div>
