      ...
      <div className='w-[100%]  flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]'>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
           Mercenta was built for smart, seamless shopping bringing you quality products, trending styles, and everyday essentials all in one place. With dependable service, fast delivery, and unbeatable value, Mercenta makes your online shopping experience effortless, enjoyable, and stress-free.
          </p>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
             Designed for today’s shoppers blending style, convenience, and affordability. From fashion and everyday essentials to the latest trends, we bring it all together on one trusted platform, offering fast delivery, hassle-free returns, and a shopping experience centered around you.
          </p>
          <p className='lg:w-[80%] w-[100%] text-[15px] text-[white] lg:text-[18px] mt-[10px] font-bold'>Our Mission</p>
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]'>
            At Mercenta, our mission is to redefine online shopping by delivering quality, affordability, and convenience. We connect customers with trusted products and brands, offering a seamless, customer-first experience that saves time, adds value, and suits every lifestyle and need.
          </p>
        </div>
      </div>
